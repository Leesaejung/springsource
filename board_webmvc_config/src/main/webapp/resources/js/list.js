...
/*
  하단의 페이지 번호 클릭 시
  a 태그 기본 기능 중지
  a 태그 href 값 가져온 후 openForm의 page요소의 value값으로 세팅
  actionForm 전송
*/
...
//  상단의 amount 수정 시 openForm의 amount요소의 value값으로 세팅
//  actionForm 전송
...
//  제목 클릭 시 a 태그 기능 중지
// actionForm 의 action은 /board/read 변경
