...
function showList(pageNum) {
  // 현재 게시물에 대한 댓글 가져오기
  //  page: page || 1 => page 변수값이 존재한다면 page 값 사용하고 없으면 1
...
//form submit 중지, reply, replyer 가져오기
...
// replyService.add(
//   { bno: 1582, reply: "댓글 내용15", replyer: "test15" },
//   (result) => {
//     alert(result);
//   }
// );
...
// 위의 이벤트 말고 이벤트 전파로
// 이벤트 전파 : 자식의 이벤트는 부모에게 전달 ==> read.jsp ul(48번줄) chat에 이벤트 작성
chat.addEventListener("click", (e) => {
  ...
  // rno 가져오기 (data-* 속성 값 가져오기 : dataset)
