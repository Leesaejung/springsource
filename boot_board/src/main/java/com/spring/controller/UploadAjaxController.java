...
//	}
	...
	public ResponseEntity<Resource> downloadFile(String fileName,@RequestHeader("User-Agent") String userAgent){
		...
		// c:\\upload\\2023\05\30\020faa8f-ac4b-452a-aca8-340bd5dfa0a2_testimg.jpg
	...
	public ResponseEntity<String> deleteFile(String fileName, String type){
		...
		// 특수문자 인코딩 일어남 ==> 경로에 있는 \ 가 %5C로 인코딩 됨
		// 2023%5C05%5C30%5Cc6012d04-9125-4d71-b59d-09256123d0ea_ca.txt file
		// 2023%5C05%5C30%5Cs_40da88bc-8a79-4c0f-9f6a-9961048e6334_testimg.jpg image
		try {
			File file = new File("c:\\upload\\", URLDecoder.decode(fileName, "utf-8"));
			  // 이미지 : 원본, 썸네일 이미지 제거
			  // txt : 파일 제거
			
			file.delete(); // txt 파일 삭제, 썸네일 삭제
